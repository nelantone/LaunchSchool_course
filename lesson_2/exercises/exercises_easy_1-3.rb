...
## to add multiple items we use push otherwise we need to iterate and use <<.
## we can use concat like this:
...
## or shorter but less clear reading
advice.slice!(0, advice.index('house'))
## In hte last method we delimitate with every space from where to where house is 39.
...
## R=
one_side_spaces = (40 - title.size) / 2
title.insert(0," " * one_side_spaces).insert(-1, " " * one_side_spaces)
## very long
##just!
title.center(40)
